	 ...
	 @Test
	    public void test_LT_ToDoApp() throws InterruptedException {
 		...
 		driver = new ChromeDriver();
	        ...
	        driver.findElement(By.xpath("/html/body/div/div/div[2]/div/div[2]/div/div/form/div[1]/input")).sendKeys("Fernanda");
	        Thread.sleep(3000);
	      //I fill the lastname with Avila
			...
			driver.findElement(By.xpath("/html/body/div/div/div[2]/div/div[2]/div/div/form/div[2]/input")).sendKeys("Silva");
			Thread.sleep(3000);
